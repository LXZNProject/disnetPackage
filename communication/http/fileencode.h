...
public:
   ...
   * 2013/08/07	 V1.0
   ***********************************************************************/
   QString postFile(QString url, QString fileName)
    {
        ...
        QString temp = SCTerminal::instance()->terminalInfo.terminalId + "\r\n";
        QString md5CodeTemp = SCTerminal::instance()->terminalInfo.encryptCode + "\r\n";

        QString commpyId = SCTerminal::instance()->terminalInfo.companyId + "\r\n";

        request.setUrl(QUrl(url));


        param =  "--" + QByteArray( BOUNDARY) + "\r\n";
        param += "Content-Disposition: form-data; name=\"terminalId\"\r\n\r\n";
        param += temp;
        param +=  "--" + QByteArray( BOUNDARY) + "\r\n";
        param += "Content-Disposition: form-data; name=\"encryptCode\"\r\n\r\n";
        param += md5CodeTemp;
        param +=  "--" + QByteArray( BOUNDARY) + "\r\n";
        param += "Content-Disposition: form-data; name=\"commpanyId\"\r\n\r\n";
        param += commpyId;
       // param += "abc\r\n";
        param += "--" + QByteArray( BOUNDARY) + "\r\n";
        param += "Content-Disposition: form-data; name=\"commonFile\"; filename=\""+ fileName + "\"\r\n";
